...
console.log('OpenSea Bidding Bot -- 0xNccB.eth');
console.log('-------- Start --------');
...
const ipfsHosts = process.env.IPFS_HOSTS;
// const ethersProvider = new ethers.providers.JsonRpcProvider(process.env.PROVIDER, 'mainnet');
const ethersProvider = new ethers.providers.InfuraProvider(null,  "e5be7b748ddb4bbeba0d6cd179687a6c"  )
